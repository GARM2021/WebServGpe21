...
class PredialPDF extends Controller
{
    ...
    public function azteca(){
     ...
     public function hsbc(){
        ...
        // print_r("ESTOY EN PREDIALPDF HSBC"); die();
        ...
        $pdf->Text(15, $y, 'Servicio a Pagar');
        $y += 0.5;
        if (is_file($_SERVER["DOCUMENT_ROOT"] . '/logo_HSBC_v11.jpg')) {
            $pdf->Image($_SERVER["DOCUMENT_ROOT"] . '/logo_HSBC_v11.jpg', 13.4, $y, 3, null);
        } else {
      ...
      //  }
        ...
        $pdf->Text(11, $y + 0.6, utf8_decode('Instrucciones para el cajero'));
             ...
             $text1 = "1. Acude a cualquier sucursal de Banco HSBC \n";
            ...
            $text2 .= "2. Buscar al Emisor: MUNICIPIO DE GUADALUPE NL y selecciona el contrato 5284\n";
            $text2 .= "3. Ingresa la Referencia de 19 digitos que viene en el formato de pago\n";
            $text2 .= "4. Selecciona la Forma de Pago Efectivo y teclea el importe a pagar que viene en el formato de pago\n";
            $text2 .= "\n\n SPEI BANCO HSBC Clave Interbancaria: 021180550300052848\n";
            $text2 .= "  Referencia : $referencia ";
            //$text2 .= "\n Para cualquier duda sobre como cobrar, por favor llamar al teléfono 01 800 300 08 08 en un horario de 8am a 9pm de lunes a domingo";
